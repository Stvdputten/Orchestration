...
echo "Running the baseline tests for all kubernetes benchmarks and compare it to Swarms"
...
export availability=0 # high-availability
export unlimited=1    # Unlimited resources
export horizontal=1   # Horizontal scaling
export vertical=1     # Vertical scaling
export N=5            # Number of times to run the experiment
