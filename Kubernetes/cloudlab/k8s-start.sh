...
pssh -i -h $ips "sudo apt remove containerd"
pssh -i -h $ips "sudo apt update && sudo apt install containerd.io"
pssh -i -h $ips "sudo rm /etc/containerd/config.toml"
pssh -i -h $ips "sudo systemctl restart containerd"
