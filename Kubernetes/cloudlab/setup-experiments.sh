...
pssh -i -h $ips  "cd DeathStarBench && git pull && git reset --hard origin/main" > /dev/null 2>&1
ssh -n $remote "cd DeathStarBench && git reset --hard origin/main && git pull" > /dev/null 2>&1
